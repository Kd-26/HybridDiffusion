...
if _TORCH_VERSION >= (2, 10):
    ...
    _PipelineScheduleRuntime = None  # type: ignore[assignment, misc]
    OVERLAP_F_B = None  # type: ignore[assignment]
    ScheduleDualPipeV = None  # type: ignore[assignment, misc]
    ScheduleZBVZeroBubble = None  # type: ignore[assignment, misc]
