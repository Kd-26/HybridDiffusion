"""
ARC-Challenge evaluation across one or more SGLang servers.

Uses allenai/ai2_arc ARC-Challenge split, 4-choice (A/B/C/D).

Normally invoked through ``scripts/evaluate.sh``. Direct usage:
  python benchmark_clients/quality/eval_arc_c.py --ports 30000
"""
import argparse
import json
import os
...
def main():
    ...
    if args.output_dir:
        ...
        with open(os.path.join(args.output_dir, f"arc_c_summary{tag}.json"), "w") as f:
