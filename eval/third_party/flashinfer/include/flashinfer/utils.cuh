...
#define DISPATCH_MASK_MODE(mask_mode, MASK_MODE, ...)             \
  switch (mask_mode) {                                            \
    ...
    case MaskMode::kDllmBidirBlock: {                             \
      constexpr MaskMode MASK_MODE = MaskMode::kDllmBidirBlock;   \
      __VA_ARGS__                                                 \
      break;                                                      \
    }                                                             \
    case MaskMode::kDllmTypedBidirBlock: {                        \
      constexpr MaskMode MASK_MODE = MaskMode::kDllmTypedBidirBlock; \
      __VA_ARGS__                                                 \
      break;                                                      \
    }                                                             \
    default: {                                                    \
