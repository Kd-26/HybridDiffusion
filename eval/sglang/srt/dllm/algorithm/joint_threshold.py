...
class JointThreshold(DllmAlgorithm):
    ...
    def run(
        ...
        # Final commit forward: always persist GDN state.
        # Even if softmax KV doesn't need re-forwarding (no changes),
        # GDN state was not committed during intermediate iterations.
